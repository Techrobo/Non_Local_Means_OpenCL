...
int main(int argc, char** argv) {
	...
	*/
	...
	std::cout << std::endl;
	Iterate over all implementations (1. Global Memory and 2. Shared Memory)
	for (int impl = 1; impl <= 2; impl++) {
		...
		*/
		...
		std::string kernelName = "nlmKernel" + boost::lexical_cast<std::string> (impl);
    ...
    */
		...
		Core::writeImagePGM("output_nlm_gpu_" + boost::lexical_cast<std::string> (impl) + ".pgm", h_outputGpu, countX, countY);
    /*
